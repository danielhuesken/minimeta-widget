<?PHP
//aktivierte plugins only File names in lower case
...
if (in_array("wp-ban.php",$plugins)) $adminlinks[1][10] = array(__('WP-ServerInfo', 'wp-serverinfo'), '1', 'index.php?page=wp-serverinfo/wp-serverinfo.php'); //menu link
...
if (in_array("wp-useronline.php",$plugins)) $adminlinks[40][54] = array(__('Useronline', 'wp-useronline'), 'manage_options', 'options-general.php?page=wp-useronline/useronline-options.php');
